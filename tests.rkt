...
(redex-chk
 ...
 hole (Δ-ref-index-Ξ Δnb INat)
 ((Iz : INat) (Is : (Π (x : INat) INat))) (Δ-ref-constructor-map Δnb INat)
 (hole (Π (x : INat) hole)) ((Δ-constructor-ref-index-Ξ Δnb Iz)
                             (Δ-constructor-ref-index-Ξ Δnb Is))
 hole (Δ-constructor-ref-index-Ξ Δlist Inil)
